...
import static de.bonbonkocher.launcher.window.MainWindow.windowH;
import static de.bonbonkocher.launcher.window.MainWindow.windowL;
...
public class GamePanel extends JPanel{
  ...
  public static final String IMAGE_DIR = "/images/background/";
  private final Dimension prefSize = new Dimension(windowL, windowH);
  ...
  private void doOnTick() {        
    ...
    if (tanksDestroyedCounter > 500) endGame();
